...
import TALLER.taller4.Ferry;
import TALLER.taller4.FerryCompany;
import TALLER.taller4.PierA;
import TALLER.taller4.PierB;
import TALLER.taller4.PierC;
...
public class TestPiers {
    public static void main(String[] args) {
        ...
        TALLER.taller4.FerryCompany transLink = new TALLER.taller4.FerryCompany("Translink");
        ...
        try { // Falla porque las compañías no coinciden
            waterfront.dock(new Ferry("Spirit of Vancouver", new TALLER.taller4.FerryCompany("BC Ferries")),
                    LocalTime.of(10, 10));
        } catch (Exception ex) {
            System.out.println("Error"); // Error
        }
        ...
        try {
            ...
            waterfront.undock(new Ferry("Spirit of Vancouver", new TALLER.taller4.FerryCompany("BC Ferries")),
                    LocalTime.of(10, 20));
        ...
        TALLER.taller4.PierC stanleyPark = new PierC("Stanley Park", transLink, 3,
