...
public class HelpDesk {
    //  para que tenga un orden natural inverso al orden que necesitamos
    //  entonces ya no se puede utilizar EnumMap y en su lugar se debe utilizar un TreeMap
    private Map<ClientType, Queue<HelpTicket>> queuesByClient = new TreeMap<>(Comparator.reverseOrder());
