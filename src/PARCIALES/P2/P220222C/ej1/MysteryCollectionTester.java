...
public class MysteryCollectionTester {
    public static void main(String[] args) {
        ...
        System.out.println(mc1.first());    // 99

        // Obtiene el último elemento de la colección
        System.out.println(mc1.last());     // 11
        ...
        // Importante: después de hacer el zip, se modifica mc1
        mc1.add(50);
        ...
        System.out.println(new MysteryCollectionImpl<Integer>().zip(mc1).isEmpty());             // true
