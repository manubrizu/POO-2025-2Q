...
public class LoungeTester {
    public static void main(String[] args) {
        ...
        Lounge lounge = new Lounge(central,"Ezeiza Lounge");
        ...
        // de todas las aerolíneas que cuenten con al menos un pase cuando está abierto
        Lounge capLounge = new CapLounge(central,"The Centurion", 3);
        ...
        try {
            ...
            System.out.println(ex.getMessage()); // Not enough guests to exit
        }
        ...
        Lounge airLounge = new AirlineCapLounge(central, "VIP Lounge", 4, "LATAM");
